    ...
    return (
        <div className='flex flex-col items-center m-8'>
            <div className='text-center'>
                <h1 className='text-4xl sm:text-5xl md:text-6xl mb-6'>Elevate <span className='text-blue-500 font-bold'>Real Estate Success </span> with <br /> Osumare's Digital Experties</h1>
